 ...
 * 
 */
public class TaskSearchCriteriaDialog extends Dialog implements ISearchCritieraDialog {

	@SuppressWarnings("unused")
	private DataBindingContext m_bindingContext;

	private TaskSearchCritieria criteria;
	 ...
	 * @param parentShell
	 */
	public TaskSearchCriteriaDialog(Shell parentShell, TaskSearchCritieria criteria) {
		super(parentShell);
		if (criteria == null) {
			criteria = new TaskSearchCritieria();
		}
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText("Task Search Criteria Settings");
	}
	 ...
	 * @return the criteria
	 */
	public TaskSearchCritieria getCriteria() {
		return criteria;
	}
	 ...
	 *            the criteria to set
	 */
	public void setCriteria(TaskSearchCritieria criteria) {
